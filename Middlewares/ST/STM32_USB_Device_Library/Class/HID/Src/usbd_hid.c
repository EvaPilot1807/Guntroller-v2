...
<<<<<<< HEAD
  /* --- 16-BIT X and Y AXIS (The High Res Fix) --- */
    ...
    /* Logical Min/Max: -32767 to 32767 */
    0x16, 0x01, 0x80,  /* Logical Minimum (-32767)           */
    0x26, 0xFF, 0x7F,  /* Logical Maximum (32767)            */

    0x75, 0x10,        /* Report Size (16) <- CRITICAL: 16 BITS */
    0x95, 0x02,        /* Report Count (2) <- X and Y only   */
    0x81, 0x06,        /* Input (Data,Var,Rel)               */

    /* --- 8-BIT SCROLL WHEEL (Keep this standard) --- */
    0x09, 0x38,        /* Usage (Wheel)                      */
    /* Logical Min/Max: -127 to 127 */
